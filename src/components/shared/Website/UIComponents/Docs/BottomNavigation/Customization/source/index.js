...
export default function FixedBottomNavigation() {
  ...
  return (
    <div
      style={{ paddingBottom: 7, width: "100%", position: "relative" }}
      ref={ref}
    >
...
const messageExamples = [
  ...
  },
  {
    ...
    person:
      "https://tse2.mm.bing.net/th?id=OIP.vBH5Byp8zaP4QyuQxtpzqwHaHa&pid=Api&P=0&h=220",
  },
  {
    primary: "Discussion",
    secondary: \`Menus that are generated by the bottom app bar (such as a bottom
      ...
      than the bar.\`,
    person:
      "https://tse1.mm.bing.net/th?id=OIP.VkAMJ7tPlTf22T4vZ2ozjgHaHa&pid=Api&P=0&h=220",
  },
  {
    primary: "Summer BBQ",
    ...
    person:
      "https://tse4.mm.bing.net/th?id=OIP.x7BxPfPVRYSFkqD9ZatItQHaHa&pid=Api&P=0&h=220",
  },
];
`;
