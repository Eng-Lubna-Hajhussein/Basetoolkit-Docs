...
export const autocompleteContent = [
  ...
  { label: "#Controlled States", href: "#controlled-states" },
  { label: "#Disabled Options", href: "#disabled-options" },
  { label: "#Fixed Options", href: "#fixed-options" },
  { label: "#Limit Tags", href: "#limit-tags" },
  { label: "#Custom Highlight", href: "#custom-highlight" },
  { label: "#Creatable Options", href: "#creatable-options" },
  { label: "#Async Data Fetch", href: "#async-data-fetch" },
  { label: "#Checkbox Selection", href: "#checkbox-selection" },
